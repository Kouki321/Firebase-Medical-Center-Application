                ...
                <tr v-for="user in filteredEtudiants" :key="user.userId"   >
                  ...
                  <td class="text-center">
                    <div class="d-flex flex-column justify-content-center">
                      ...
                      <h5 class="mb-0 text-sm" v-if="user.doctor">{{ user.role }}</h5>
                      <h5 class="mb-0 text-sm" v-if="user.patient">Patient</h5>
                    </div>
                  </td>
                  <td class="text-center">
                    <div class="d-flex flex-column justify-content-center">
...
.doctor-row {//:class="{ 'doctor-row': user.doctor , 'patient-row':user.patient }
  background-color: #65c4ff; /* Light green background */
}
.patient-row{
