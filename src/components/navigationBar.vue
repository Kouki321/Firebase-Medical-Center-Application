<template>
    ...
    <nav class="container">
            <div class="branding">
                <router-link class="header" :to="{name:'HomeView'}">Medical Center</router-link>
            </div>
            <div class="nav-links">
                <ul v-show="!mobile">
                    ...
                    <router-link v-if="admin" class="link"  :to="{name:'createdoctorView'}">Create Doctor</router-link>
                    ...
                    <router-link v-if="patient" class="link" :to="{name:'alldoctorsView'}">Doctors</router-link>
                    <router-link v-if="doctor || patient" class="link" :to="{ name: 'chat', params: { userId: userId } }">Chat Admin</router-link>
                    <router-link v-if="admin" class="link" :to="{ name: 'adminchatView', params: { userId: userId } }">Chat</router-link>
                    <router-link v-if="patient" class="link" :to="{ name: 'chatwithallpatietdoctorView', params: { userId: userId } }">Chat with doctors</router-link>
                    <router-link v-if="doctor" class="link" :to="{ name: 'alldoctorchatwithpatientView', params: { userId: userId } }">Chat with patients</router-link>
                    <router-link v-if="doctor" class="link" :to="{ name: 'allPatientsView' }">Patients</router-link>
                    <router-link v-if="doctor" class="link" :to="{ name: 'DoctorRequests' }">Requests</router-link>
                    <router-link v-if="patient" class="link" :to="{ name: 'AppointmentRequestView',  }">Appointments Request</router-link>
                    <router-link v-if="doctor" class="link" :to="{ name: 'AppointmentReceivedtView',  }">Appointments Received</router-link>
                    <router-link v-if="admin" class="link" :to="{ name: 'adminAppointmentView',  }">Appointments</router-link>
    ...
    computed:{
      ...
      return this.$store.state.user?.uid; // Optional chaining for safety
        ...
        admin(){
            ...
            return this.$store.state.profileDoctor;
        },patient(){
